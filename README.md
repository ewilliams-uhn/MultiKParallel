...
## Installing
**MultiKParallel** relies on the following R packages: **Seurat**, **SigClust**, please install them before installing **MultiKParallel**.
...
#library(devtools)
#install_github("ewilliams-uhn/MultiKParallel")
```

**MultiKParallel( )** is the main function that implements the subsampling and application of the Seurat clustering over multiple resolution parameters. Details about this function can be found in the user manual:
...
### Step 1: Run **MultiKParallel** main algorithm to determine optimal Ks
