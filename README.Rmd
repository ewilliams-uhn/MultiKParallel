...
Single cell RNA-seq analysis tool that objectively selects multiple insightful numbers of clusters (*K*). Fork of MultiK that enables parallel computing.
...
## Installing
**MultiKParallel** relies on the following R packages: **Seurat**, **SigClust**, 
and **doSNOW**. Please install them before installing **MultiKParallel**.
...
```{}
multik <- MultiKParallel(seu, reps=10)
```
